							...
							<tbody>
								<%
									try {
										...
										String query = "select * from ogrenci where StajiBittiMi='"+1+"'";
										...
										while (rs.next()) {
											...
											System.out.print(rs.getString("Ogretim") + "   ");
											System.out.println(rs.getString("TamamlamasiGerekenGun"));
								%>
								<tr>
									...
									<td><%=rs.getString("TamamlamasıGerekenGun")%></td>
								</tr>
								<%
									}
									} catch (Exception ex) {
